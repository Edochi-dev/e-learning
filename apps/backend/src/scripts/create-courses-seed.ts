  ...
  const coursesToSeed: Partial<Course>[] = [
      ...
      lessons: [
        {
          ...
          description: 'Conoce todo lo necesario para empezar.',
          duration: '15:00',
          videoUrl: 'http://localhost:3000/videos/videos/clase1.mp4',
          isLive: false,
        },
        {
          title: 'Preparación de la uña natural',
          description: 'Pasos vitales para evitar desprendimientos.',
          duration: '20:00',
          videoUrl: 'http://localhost:3000/videos/videos/clase2.mp4',
          isLive: true,
        },
        {
          title: 'Aplicación de tips',
          description: 'Técnica correcta de pegado y limado.',
          duration: '25:00',
          videoUrl: 'http://localhost:3000/videos/videos/clase3.mp4',
          isLive: false,
        },
      ] as any[],
    },
    ...
    },
    {
      ...
      lessons: [
        {
          title: 'Uso del torno',
          description: 'Fresas y velocidades seguras.',
          duration: '40:00',
          videoUrl: 'http://localhost:3000/videos/videos/clase1.mp4',
          isLive: true,
        },
